...
var createSwatches = function createSwatches() {
  var userText = $('textarea').val().toLowerCase();
  var splitText = userText.split(' ');
  var colorArray = [];

  _swatches_helpers2.default.colorSifter(splitText, colorArray);
  var uniqueText = _swatches_helpers2.default.unique(colorArray);
...
var colorSifter = function colorSifter(array, colorArray) {
  array.forEach(function (word) {
    if (_colors2.default[word]) {
      (0, _post_colors2.default)(word);
...
var postColor = function postColor(color) {
  var colorPayload = { "color": { "value": color } };
...
var colorAppender = function colorAppender(arrayOfColors) {
  arrayOfColors.forEach(function (color) {
    var hexValue = _colors2.default[color];
